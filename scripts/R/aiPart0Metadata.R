...
# open the url for the bill text in the default web browser
#browseURL(aiBillData$Y20192020$SB730$text)

# Topic from aiBillData$Y20192020$SB730$status
aiBillData$Y20192020$SB730$topic <- "SB-730 Commission on Tech Equity"

# Title from aiBillData$Y20192020$SB730$status
aiBillData$Y20192020$SB730$title <- paste0(aiBillData$Y20192020$SB730$title, "An act to add and repeal Chapter 3.7 (commencing with Section 8299) of Division 1 of Title 2 of the Government Code, relating to employment development")

# tldr for aiBillData$Y20192020$SB730$text
aiBillData$Y20192020$SB730$tldr <- "SB-730 establishes the Commission on Tech Equity to address issues of equity and inclusion in the technology sector. The commission will focus on promoting diversity, equity, and access in technology-related fields and industries. It aims to ensure that all Californians have equal opportunities to participate in and benefit from the technology economy."
...
aiBillData$Y20192020$SB730$dateEnd <- as.Date("2020-11-30")
aiBillData$Y20192020$SB730$dateUpdated <- Sys.Date()

# measures
aiBillData$Y20192020$SB730$version <- "Amended Assembly"
aiBillData$Y20192020$SB730$outcome <- "Failed"
aiBillData$Y20192020$SB730$chaptered <- FALSE
aiBillData$Y20192020$SB730$chapterNo <- NA
aiBillData$Y20192020$SB730$active <- FALSE
aiBillData$Y20192020$SB730$result <- "Died"
aiBillData$Y20192020$SB730$vote <- "Majority"
aiBillData$Y20192020$SB730$appropriation <- FALSE
aiBillData$Y20192020$SB730$fiscal <- TRUE
aiBillData$Y20192020$SB730$local <- FALSE
aiBillData$Y20192020$SB730$urgency <- FALSE
aiBillData$Y20192020$SB730$tax <- FALSE
aiBillData$Y20192020$SB730$action <- "From Assembly without further action"
aiBillData$Y20192020$SB730$pdf <- "20190SB730_95.pdf"

# AI properties assessed from the text in aiBillData$Y20192020$SB730$text
aiBillData$Y20192020$SB730$aiDisposition <- "Supportive"
aiBillData$Y20192020$SB730$aiType <- "General"
aiBillData$Y20192020$SB730$aiSector <- "Governance"
aiBillData$Y20192020$SB730$aiSubSector <- "Policy and Regulation"
aiBillData$Y20192020$SB730$aiDomain <- "Technology"
aiBillData$Y20192020$SB730$aiAccountability <- "Moderate"
aiBillData$Y20192020$SB730$aiImpact <- "Moderate"
aiBillData$Y20192020$SB730$aiEthics <- "Moderate"
...
# dateStart, dateEnd, and dateUpdated
aiBillData$Y20212022$AB178$dateStart <- as.Date("2022-01-08")
aiBillData$Y20212022$AB178$dateEnd <- as.Date("2022-06-30")
aiBillData$Y20212022$AB178$dateUpdated <- Sys.Date()

# measures
aiBillData$Y20212022$AB178$version <- "Chaptered"
aiBillData$Y20212022$AB178$outcome <- "Chaptered"
aiBillData$Y20212022$AB178$chaptered <- TRUE
aiBillData$Y20212022$AB178$chapterNo <- 45
aiBillData$Y20212022$AB178$active <- FALSE
aiBillData$Y20212022$AB178$result <- "Chaptered"
aiBillData$Y20212022$AB178$vote <- "Majority"
aiBillData$Y20212022$AB178$appropriation <- TRUE
aiBillData$Y20212022$AB178$fiscal <- TRUE
aiBillData$Y20212022$AB178$local <- FALSE
aiBillData$Y20212022$AB178$urgency <- TRUE
aiBillData$Y20212022$AB178$tax <- FALSE
aiBillData$Y20212022$AB178$action <- "Chaptered by Secretary of State - Chapter 45, Statutes of 2022"
aiBillData$Y20212022$AB178$pdf <- "20210AB178_95.pdf"

# AI properties assessed from the text in aiBillData$Y20212022$AB178$text
aiBillData$Y20212022$AB178$aiDisposition <- "Restrictive"
aiBillData$Y20212022$AB178$aiType <- "General"
aiBillData$Y20212022$AB178$aiSector <- "Budget"
aiBillData$Y20212022$AB178$aiSubSector <- "State Budget"
aiBillData$Y20212022$AB178$aiDomain <- "Budget Management"
aiBillData$Y20212022$AB178$aiAccountability <- "High"
aiBillData$Y20212022$AB178$aiImpact <- "High"
aiBillData$Y20212022$AB178$aiEthics <- "High"
aiBillData$Y20212022$AB178$aiInnovation <- "Low"
...
# dateStart, dateEnd, and dateUpdated
aiBillData$Y20212022$SB179$dateStart <- as.Date("2022-01-08")
aiBillData$Y20212022$SB179$dateEnd <- as.Date("2022-11-30")
aiBillData$Y20212022$SB179$dateUpdated <- Sys.Date()

# measures
aiBillData$Y20212022$SB179$version <- "Amended Assembly"
aiBillData$Y20212022$SB179$outcome <- "Failed"
aiBillData$Y20212022$SB179$chaptered <- FALSE
aiBillData$Y20212022$SB179$chapterNo <- NA
aiBillData$Y20212022$SB179$active <- FALSE
aiBillData$Y20212022$SB179$result <- "Died"
aiBillData$Y20212022$SB179$vote <- "Majority"
aiBillData$Y20212022$SB179$appropriation <- TRUE
aiBillData$Y20212022$SB179$fiscal <- TRUE
aiBillData$Y20212022$SB179$local <- FALSE
aiBillData$Y20212022$SB179$urgency <- TRUE
aiBillData$Y20212022$SB179$tax <- FALSE
aiBillData$Y20212022$SB179$action <- "Died on the inactive file"
aiBillData$Y20212022$SB179$pdf <- "20210SB179_96.pdf"

# AI properties assessed from the text in aiBillData$Y20212022$SB179$text
aiBillData$Y20212022$SB179$aiDisposition <- "Restrictive"
aiBillData$Y20212022$SB179$aiType <- "General"
aiBillData$Y20212022$SB179$aiSector <- "Budget"
aiBillData$Y20212022$SB179$aiSubSector <- "State Budget"
aiBillData$Y20212022$SB179$aiDomain <- "Budget Management"
aiBillData$Y20212022$SB179$aiAccountability <- "High"
aiBillData$Y20212022$SB179$aiImpact <- "High"
aiBillData$Y20212022$SB179$aiEthics <- "High"
aiBillData$Y20212022$SB179$aiInnovation <- "Low"
aiBillData$Y20212022$SB179$aiPrivacy <- "High"
aiBillData$Y20212022$SB179$aiTransparency <- "High"

### SB-178 ####

# open the url for the bill text in the default web browser
#browseURL(aiBillData$Y20212022$SB178$text)

# Topic from aiBillData$Y20212022$SB178$status
aiBillData$Y20212022$SB178$topic <- "SB-178 Budget Act of 2022"

# Title from aiBillData$Y20212022$SB178$status
7350-001-0001, 7350-001-3152, 7501-001-0001, 7730-001-0001, 7730-490, 7760-311-0001, 7870-001-0214, 7870-101-0001, 7870-111-0001, 8120-002-0001, 8120-491, 8260-101-0001, 8570-002-0001, 8570-102-0001, 8820-101-0001, 8880-001-9740, and 8940-301-0001 of Section 2.00 of, adding Items 0509-102-3398, 0690-006-0001, 0775-001-3085, 0840-001-3228, 0957-113-0001, 0974-113-0001, 2240-002-0890, 2240-102-0890, 2240-492, 3340-101-0001, 3360-002-0001, 3360-102-0001, 3540-101-0001, 3600-002-3288, 3600-005-0001, 3720-001-3228, 3760-102-0001, 3790-006-0001, 3790-012-0001, 3810-102-0001, 3845-102-0001, 3855-101-0001, 3860-001-3398, 3900-002-3228, 3900-101-3228, 3930-002-3288, 3930-102-3288, 3940-002-3288, 3940-101-0439, 4700-001-3398, 4700-101-3398, 5225-017-0001, 5225-022-0001, 5227-118-0001, 5227-123-0001, 6100-485, 7100-001-3288, 7100-004-0001, 7501-001-3085, 7600-002-3288, 7760-015-0001, 8880-011-0001, and 8880-011-9740 to Section 2.00 of, repealing Items 0511-002-0001, 0957-001-0001, 0957-101-0001, 2240-123-0001, 4260-011-3397, and 8570-101-3398 of Section 2.00 of, amending Sections 11.96, 12.00, 12.32, 19.54, 19.55, 20.00, 35.50, 39.00, and 99.50 of, adding Section 19.56 to, and repealing Sections 6.15 and 35.70 of, that act, relating to the state budget, and making an appropriation therefor, to take effect immediately, budget bill")

# tldr for aiBillData$Y20212022$SB178$text
aiBillData$Y20212022$SB178$tldr <- "SB-178 is the Budget Act of 2022, which outlines the state's budgetary allocations and appropriations. It includes provisions for various state departments and programs, ensuring funding for essential services and initiatives. The bill focuses on fiscal responsibility and effective resource management to support California's needs."
...
# dateStart, dateEnd, and dateUpdated
aiBillData$Y20212022$SB178$dateStart <- as.Date("2022-01-08")
aiBillData$Y20212022$SB178$dateEnd <- as.Date("2022-11-30")
aiBillData$Y20212022$SB178$dateUpdated <- Sys.Date()

# measures
aiBillData$Y20212022$SB178$version <- "Amended Assembly"
aiBillData$Y20212022$SB178$outcome <- "Failed"
aiBillData$Y20212022$SB178$chaptered <- FALSE
aiBillData$Y20212022$SB178$chapterNo <- NA
aiBillData$Y20212022$SB178$active <- FALSE
aiBillData$Y20212022$SB178$result <- "Died"
aiBillData$Y20212022$SB178$vote <- "Majority"
aiBillData$Y20212022$SB178$appropriation <- TRUE
aiBillData$Y20212022$SB178$fiscal <- TRUE
aiBillData$Y20212022$SB178$local <- FALSE
aiBillData$Y20212022$SB178$urgency <- TRUE
aiBillData$Y20212022$SB178$tax <- FALSE
aiBillData$Y20212022$SB178$action <- "From Assembly without further action"
aiBillData$Y20212022$SB178$pdf <- "20210SB178_98.pdf"

# AI properties assessed from the text in aiBillData$Y20212022$SB178$text
aiBillData$Y20212022$SB178$aiDisposition <- "Restrictive"
aiBillData$Y20212022$SB178$aiType <- "General"
aiBillData$Y20212022$SB178$aiSector <- "Budget"
aiBillData$Y20212022$SB178$aiSubSector <- "State Budget"
aiBillData$Y20212022$SB178$aiDomain <- "Budget Management"
aiBillData$Y20212022$SB178$aiAccountability <- "High"
aiBillData$Y20212022$SB178$aiImpact <- "High"
aiBillData$Y20212022$SB178$aiEthics <- "High"
aiBillData$Y20212022$SB178$aiInnovation <- "Low"
aiBillData$Y20212022$SB178$aiPrivacy <- "High"
aiBillData$Y20212022$SB178$aiTransparency <- "High"
...
# open the url for the bill text in the default web browser
#browseURL(aiBillData$Y20232024$AB2652$text)

# Topic from aiBillData$Y20232024$AB2652$status
aiBillData$Y20232024$AB2652$topic <- "AB-2652 State Department of Education: artificial intelligence working group"

# Title from aiBillData$Y20232024$AB2652$status
aiBillData$Y20232024$AB2652$title <- paste0(aiBillData$Y20232024$AB2652$title, "An act to add Section 33328.5 to the Education Code, relating to the State Department of Education")

# tldr for aiBillData$Y20232024$AB2652$text
aiBillData$Y20232024$AB2652$tldr <- "AB-2652 establishes an artificial intelligence working group within the State Department of Education to evaluate the impact of AI on education. The group will assess AI's potential benefits and challenges, develop guidelines for its responsible use, and recommend policies to ensure equitable access to AI resources in schools."
...
# dateStart, dateEnd, and dateUpdated
aiBillData$Y20232024$AB2652$dateStart <- as.Date("2024-02-14")
aiBillData$Y20232024$AB2652$dateEnd <- as.Date("2024-11-30")
aiBillData$Y20232024$AB2652$dateUpdated <- Sys.Date()

# measures
aiBillData$Y20232024$AB2652$version <- "Amended Assembly"
aiBillData$Y20232024$AB2652$outcome <- "Failed"
aiBillData$Y20232024$AB2652$chaptered <- FALSE
aiBillData$Y20232024$AB2652$chapterNo <- NA
aiBillData$Y20232024$AB2652$active <- FALSE
aiBillData$Y20232024$AB2652$result <- "Died"
aiBillData$Y20232024$AB2652$vote <- "Majority"
aiBillData$Y20232024$AB2652$appropriation <- FALSE
aiBillData$Y20232024$AB2652$fiscal <- TRUE
aiBillData$Y20232024$AB2652$local <- FALSE
aiBillData$Y20232024$AB2652$urgency <- FALSE
aiBillData$Y20232024$AB2652$tax <- FALSE
aiBillData$Y20232024$AB2652$action <- "From committee without further action"
aiBillData$Y20232024$AB2652$pdf <- "2023AB2652_97.pdf"

# AI properties assessed from the text in aiBillData$Y20232024$AB2652$text
aiBillData$Y20232024$AB2652$aiDisposition <- "Restrictive"
aiBillData$Y20232024$AB2652$aiType <- "General"
aiBillData$Y20232024$AB2652$aiSector <- "Education"
aiBillData$Y20232024$AB2652$aiSubSector <- "K-12 Education"
aiBillData$Y20232024$AB2652$aiDomain <- "Education Management"
aiBillData$Y20232024$AB2652$aiAccountability <- "High"
aiBillData$Y20232024$AB2652$aiImpact <- "High"
aiBillData$Y20232024$AB2652$aiEthics <- "High"
aiBillData$Y20232024$AB2652$aiInnovation <- "Low"
